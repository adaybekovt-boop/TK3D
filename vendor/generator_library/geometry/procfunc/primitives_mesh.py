...
def mesh_line(points: list[Vector] | np.ndarray) -> t.MeshObject:
...
def mesh_plane(
    ...
    **kwargs: Any,
    ...
    bpy.ops.mesh.primitive_plane_add(
        size=size, calc_uvs=calc_uvs, enter_editmode=enter_editmode,
        align=align, location=location, rotation=rotation, scale=scale, **kwargs
    )
    return t.MeshObject(bpy.context.active_object)
...
def mesh_cube(
    ...
    **kwargs: Any,
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=size, calc_uvs=calc_uvs, enter_editmode=enter_editmode,
        align=align, location=Vector(location), rotation=Euler(rotation),
        scale=Vector(scale), **kwargs
    )
    return t.MeshObject(bpy.context.active_object)
...
def mesh_icosphere(
    ...
    **kwargs: Any,
    ...
    bpy.ops.mesh.primitive_ico_sphere_add(
        subdivisions=subdivisions, radius=radius, calc_uvs=calc_uvs,
        enter_editmode=enter_editmode, align=align, location=location,
        rotation=rotation, scale=scale, **kwargs
    )
    return t.MeshObject(bpy.context.active_object)
...
def mesh_cylinder(
    ...
    **kwargs: Any,
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        vertices=vertices, radius=radius, depth=depth, end_fill_type=end_fill_type,
        calc_uvs=calc_uvs, enter_editmode=enter_editmode, align=align,
        location=location, rotation=rotation, scale=scale, **kwargs
    )
    return t.MeshObject(bpy.context.active_object)
...
def mesh_cone(
    ...
    **kwargs: Any,
    ...
    bpy.ops.mesh.primitive_cone_add(
        ...
        end_fill_type=end_fill_type, calc_uvs=calc_uvs,
        enter_editmode=enter_editmode, align=align, location=location,
        rotation=rotation, scale=scale, **kwargs
    )
    return t.MeshObject(bpy.context.active_object)
...
def mesh_torus(
    ...
    **kwargs: Any,
    ...
    bpy.ops.mesh.primitive_torus_add(
        align=align, location=location, rotation=rotation,
        major_segments=major_segments, minor_segments=minor_segments,
        mode=mode, major_radius=major_radius, minor_radius=minor_radius,
        abso_major_rad=abso_major_rad, abso_minor_rad=abso_minor_rad,
        generate_uvs=generate_uvs, **kwargs
    )
    return t.MeshObject(bpy.context.active_object)
...
def mesh_circle(
    ...
    **kwargs: Any,
    ...
    bpy.ops.mesh.primitive_circle_add(
        vertices=vertices, radius=radius, fill_type=fill_type,
        calc_uvs=calc_uvs, enter_editmode=enter_editmode, align=align,
        location=location, rotation=rotation, scale=scale, **kwargs
    )
    return t.MeshObject(bpy.context.active_object)
